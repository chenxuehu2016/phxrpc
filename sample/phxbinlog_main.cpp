...
void HttpDispatch( const phxrpc::HttpRequest & request, phxrpc::HttpResponse * response, phxrpc::DispatcherArgs_t * args ) {
    ...
    phxrpc::HttpDispatcher<PhxbinlogDispatcher> http_dispatcher(
            dispatcher, PhxbinlogDispatcher::GetURIFuncMap() );
...
int main( int argc, char * argv[] ) {
    ...
    service_args.svr_handler_ = new PhxbinlogServerHandler();
